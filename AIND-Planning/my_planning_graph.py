...
class PlanningGraph():
    ...
    def inconsistent_effects_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        eff_pos_a1 = node_a1.action.effect_add
        eff_neg_a1 = node_a1.action.effect_rem
        eff_pos_a2 = node_a2.action.effect_add
        eff_neg_a2 = node_a2.action.effect_rem
        
        for eff in eff_pos_a1:
            if eff in eff_neg_a2:
                return True
        
        for eff in eff_pos_a2:
            if eff in eff_neg_a1:
                return True
    ...
    def interference_mutex(self, node_a1: PgNode_a, node_a2: PgNode_a) -> bool:
        ...
        for eff in eff_pos_a1:
            if eff in precond_neg_a2:
                return True
        
        for eff in eff_neg_a1:
            if eff in precond_pos_a2:
                return True

        for eff in eff_pos_a2:
            if eff in precond_neg_a1:
                return True
        
        for eff in eff_neg_a2:
            if eff in precond_pos_a1:
                return True            
    ...
    def negation_mutex(self, node_s1: PgNode_s, node_s2: PgNode_s) -> bool:
        ...
        return (isinstance(node_s1, node_s2.__class__) and
                node_s1.is_pos == (not node_s2.is_pos) and
